...
class FPMChangeProvider implements FPMChangeProviderInterface {
  ...
  handleCurrentFPMSelection = (method: string): void => {
    ...
    this.createUserResponseRecord(
      method,
      'current_fpm_selection',
      'Which method are you currently using?',
      'currentFPMOptions',
    );
  ...
  handleFPMConcernTypeSelection = (concernType: string): void => {
    ...
    console.log(
      '🔍 Type of this.currentMethod:',
      typeof this.state.currentFPMMethod,
    );
    console.log(
    ...
    const methodToUse =
      this.currentMethodLocal || this.state.currentFPMMethod || '';
    ...
    this.createUserResponseRecord(
      concernType,
      'fpm_concern_selection',
      'What specific concern do you have?',
      'fpmConcernTypeOptions',
    );
