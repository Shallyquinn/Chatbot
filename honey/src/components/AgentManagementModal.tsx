...
import { X, ChevronDown, Trash2, AlertTriangle, UserPlus, Users as UsersIcon, Eye, EyeOff } from 'lucide-react';
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      setFormData({
        ...
        email: '',
        role: '',
        password: generateDefaultPassword(), // Generate new password for next agent
        state: '',
        lga: '',
        primaryLanguage: '',
        secondaryLanguage: '',
          ...
          {activeView === 'add' ? (
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col gap-6">
                ...
                {/* Password Field */}
                <div className="flex flex-col gap-2">
                  <label htmlFor="password" className="font-medium text-[#383838] text-[14px]">
                    Default Password
                  </label>
                  <div className="relative">
                    <input
                      ...
                      } rounded-[7px] p-3 pr-12 text-[14px] placeholder:text-[#7b7b7b] focus:outline-none focus:border-[#006045] focus:ring-1 focus:ring-[#006045] transition-all`}
                    />
                    <button
                      type="button"
                    ...
                    >
                      {showPassword ? (
                        <EyeOff className="w-4 h-4 text-[#7b7b7b]" />
                      ) : (
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  {/* State */}
                  <div className="flex-1 flex flex-col gap-2">
                    <label htmlFor="state" className="font-medium text-[#383838] text-[14px]">
                      State
                    </label>
                    <select
                      id="state"
                      ...
                      } rounded-[7px] p-3 text-[14px] focus:outline-none focus:border-[#006045] focus:ring-1 focus:ring-[#006045] transition-all`}
                    >
                  ...
                  {/* LGA */}
                  <div className="flex-1 flex flex-col gap-2">
                    <label htmlFor="lga" className="font-medium text-[#383838] text-[14px]">
                      LGA
                    </label>
                    <input
                      id="lga"
                    ...
                    />
                    {errors.lga && <span className="text-red-500 text-xs">{errors.lga}</span>}
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  {/* Primary Language */}
                  <div className="flex-1 flex flex-col gap-2" data-dropdown-container>
                    <label htmlFor="primaryLanguage" className="font-medium text-[#383838] text-[14px]">
                      Primary Language
                    </label>
                    <div className="relative">
                      <button
                    ...
                    {errors.primaryLanguage && <span className="text-red-500 text-xs">{errors.primaryLanguage}</span>}
                  </div>

                  {/* Secondary Language */}
                  <div className="flex-1 flex flex-col gap-2" data-dropdown-container>
                    <label htmlFor="secondaryLanguage" className="font-medium text-[#383838] text-[14px]">
                    ...
                    <div className="relative">
                      <button
                        ...
                        className="w-full bg-[#fbfbfb] border border-[#dedede] rounded-[7px] p-3 text-[14px] flex items-center justify-between focus:outline-none focus:border-[#006045] focus:ring-1 focus:ring-[#006045] transition-all"
                      >
