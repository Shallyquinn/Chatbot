...
// Define interfaces for media widget props
export interface MediaWidgetProps {
  ...
  onClick?: () => void;
  actionProvider?: any; // TODO: Replace with proper ActionProvider type
}
...
export const videoWidgets: MediaWidgetConfig[] = [
  {
    widgetName: 'hivSelfTestVideo',
    widgetFunc: (props: MediaWidgetProps) => (
      <VideoLinkWidget
        url="https://www.youtube.com/watch?v=ap08kSitc1c&list=PL0mGkrTWmp4sWe4izabrqUhEVSuQAb-Hd&index=2&pp=iAQB"
        text="Watch How to Use the HIV Self Test Kit"
        actionProvider={props.actionProvider}
      />
    ),
  },
  {
    widgetName: 'femaleCondomInsertVideo',
    widgetFunc: (props: MediaWidgetProps) => (
      <VideoLinkWidget
        url="https://www.youtube.com/watch?v=W3yRSR3ppmI&list=PL0mGkrTWmp4sWe4izabrqUhEVSuQAb-Hd&index=9"
        text="Watch How to Insert a Female Condom"
        actionProvider={props.actionProvider}
      />
    ),
  },
  {
    widgetName: 'femaleCondomRemovalVideo',
    widgetFunc: (props: MediaWidgetProps) => (
      <VideoLinkWidget
        url="https://www.youtube.com/watch?v=7me1jsqg3Wg&list=PL0mGkrTWmp4sWe4izabrqUhEVSuQAb-Hd&index=3&pp=iAQB"
        text="Watch How to Remove a Female Condom"
        actionProvider={props.actionProvider}
      />
    ),
  },
  {
    widgetName: 'diaphragmInsertVideo',
    widgetFunc: (props: MediaWidgetProps) => (
      <VideoLinkWidget
        url="https://www.youtube.com/watch?v=zw76siSZ2E4&list=PL0mGkrTWmp4sWe4izabrqUhEVSuQAb-Hd&index=5&pp=iAQB"
        text="Watch How to Insert a Diaphragm"
        actionProvider={props.actionProvider}
      />
    ),
  },
  {
    widgetName: 'diaphragmRemovalVideo',
    widgetFunc: (props: MediaWidgetProps) => (
      <VideoLinkWidget
        url="https://www.youtube.com/watch?v=ettTJHL209w&list=PL0mGkrTWmp4sWe4izabrqUhEVSuQAb-Hd&index=4&pp=iAQB"
        text="Watch How to Remove a Diaphragm"
        actionProvider={props.actionProvider}
      />
    ),
  },
  {
    widgetName: 'diaphragmGelVideo',
    widgetFunc: (props: MediaWidgetProps) => (
      <VideoLinkWidget
        url="https://www.youtube.com/watch?v=6VV1Wi67o4Y&list=PL0mGkrTWmp4sWe4izabrqUhEVSuQAb-Hd&index=1&pp=iAQB"
        text="Watch How to Use Diaphragm Gel"
        actionProvider={props.actionProvider}
      />
    ),
  },
  {
    widgetName: 'sayanaPressPidginVideo',
    widgetFunc: (props: MediaWidgetProps) => (
      <VideoLinkWidget
        url="https://www.youtube.com/watch?v=bXi_6rbJhsk&list=PL0mGkrTWmp4sWe4izabrqUhEVSuQAb-Hd&index=6&pp=iAQB"
        text="Watch How to Inject Sayana Press (Pidgin)"
        actionProvider={props.actionProvider}
      />
    ),
  },
...
export const condomsMedia = mediaWidgets.filter((widget) =>
  [
    ...
    'removeCondomAudio',
    // Videos
    'femaleCondomInsertVideo',
    'femaleCondomRemovalVideo',
  ].includes(widget.widgetName),
);
...
export const barrierMethodsMedia = mediaWidgets.filter((widget) =>
  [
    ...
    // Videos
    'diaphragmInsertVideo',
    'diaphragmRemovalVideo',
    'diaphragmGelVideo',
  ].includes(widget.widgetName),
);

// HIV Testing Media
export const hivTestingMedia = mediaWidgets.filter((widget) =>
  [
    // Videos
    'hivSelfTestVideo',
  ].includes(widget.widgetName),
...
export const instructionalMedia = mediaWidgets.filter((widget) =>
  [
    ...
    'condomUsageVideo',
    'diaphragmUsageVideo',
    'implantInsertionVideo',
    'injectableUsageVideo',
  ].includes(widget.widgetName),
);
...
// Get widget by name
export const getMediaWidgetByName = (
  name: string,
): MediaWidgetConfig | undefined => {
  return mediaWidgets.find((widget) => widget.widgetName === name);
};

// Get widgets by category
export const getMediaWidgetsByCategory = (
  category: string,
): MediaWidgetConfig[] => {
