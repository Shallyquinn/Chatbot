...
// Widget component for initial FPM selection
const GetPregnantFPMSelectionWidget = ({ actionProvider }: GetPregnantWidgetProps) => (
  <OptionButtons
    options={[
...
// Widget for trying duration (No FPM branch)
const GetPregnantTryingDurationWidget = ({ actionProvider }: GetPregnantWidgetProps) => (
  <OptionButtons
...
// Widget for IUD removal status
const GetPregnantIUDRemovalWidget = ({ actionProvider }: GetPregnantWidgetProps) => (
  <OptionButtons
    options={[
...
// Widget for Implant removal status
const GetPregnantImplantRemovalWidget = ({ actionProvider }: GetPregnantWidgetProps) => (
  <OptionButtons
    options={[
...
// Widget for injection stopping status
const GetPregnantInjectionStopWidget = ({ actionProvider }: GetPregnantWidgetProps) => (
  <OptionButtons
    options={["Yes", "No"]}
    actionProvider={actionProvider}
    handleClick={(option: string) =>
...
// Widget for pills stopping status
const GetPregnantPillsStopWidget = ({ actionProvider }: GetPregnantWidgetProps) => (
  <OptionButtons
    options={["Yes", "No"]}
    actionProvider={actionProvider}
    handleClick={(option: string) =>
...
// Widget for next action options
const GetPregnantNextActionWidget = ({ actionProvider }: GetPregnantWidgetProps) => (
  <OptionButtons
    options={[
      "Ask more questions",
      "Find nearest clinic", 
...
export const getPregnantWidgets = [
  {
    ...
    widgetFunc: (props: GetPregnantWidgetProps) => <GetPregnantFPMSelectionWidget {...props} />,
  },
  {
    widgetName: "getPregnantTryingDuration", 
    widgetFunc: (props: GetPregnantWidgetProps) => <GetPregnantTryingDurationWidget {...props} />,
  },
  {
    widgetName: "getPregnantIUDRemoval",
    widgetFunc: (props: GetPregnantWidgetProps) => <GetPregnantIUDRemovalWidget {...props} />,
  },
  {
    widgetName: "getPregnantImplantRemoval",
    widgetFunc: (props: GetPregnantWidgetProps) => <GetPregnantImplantRemovalWidget {...props} />,
  },
  {
    widgetName: "getPregnantInjectionStop",
    widgetFunc: (props: GetPregnantWidgetProps) => <GetPregnantInjectionStopWidget {...props} />,
  },
  {
    widgetName: "getPregnantPillsStop", 
    widgetFunc: (props: GetPregnantWidgetProps) => <GetPregnantPillsStopWidget {...props} />,
  },
  {
    widgetName: "getPregnantNextAction",
    widgetFunc: (props: GetPregnantWidgetProps) => <GetPregnantNextActionWidget {...props} />,
  }
];
