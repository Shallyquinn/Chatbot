...
export const RESPONSE_TYPES = {
  ...
  LUBRICANT_SELECTION: "lubricant_selection",
  ERECTILE_DYSFUNCTION_OPTION_SELECTION: "erectile_dysfunction_option_selection",
  ...
  SEX_ENHANCEMENT_NEXT_ACTION_SELECTION: "sex_enhancement_next_action_selection", // NEW
} as const;
...
export const createEmergencyProductResponse = (
  ...
  question_asked: "For emergency contraception, here are the available options:",
...
export const getWidgetOptions = (widgetName: string): string[] => {
  const widgetOptionsMap: Record<string, string[]> = {
    ...
    [WIDGET_NAMES.GENDER_OPTIONS]: ["Male 👨", "Female 👩", "Prefer not to say"],
    [WIDGET_NAMES.SEX_ENHANCEMENT_OPTIONS]: ["Gels and Lubricants", "Hard Erection"],
